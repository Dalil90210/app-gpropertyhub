...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://app.ngpropertyhub.com/" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            {
              "@type": "Organization",
              "@id": "https://app.ngpropertyhub.com/#org",
            ...
            {
              "@type": "WebSite",
              "@id": "https://app.ngpropertyhub.com/#website",
              url: "https://app.ngpropertyhub.com/",
              name: "New Guard Property Hub",
              publisher: { "@id": "https://app.ngpropertyhub.com/#org" },
              potentialAction: {
                "@type": "SearchAction",
                target: "https://app.ngpropertyhub.com/properties?q={search_term_string}",
